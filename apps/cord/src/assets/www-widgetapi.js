...
*/
  ...
  function za(a, b, c, d) {
    try {
      ...
      return (a.h.l = null), qa(a.h, g), Aa(a);
    }
    a.h.l = null;
    d.call(a.h, f);
    return Aa(a);
  ...
  function Ba(a) {
    this.next = function (b) {
      pa(a.h);
      a.h.l ? (b = za(a, a.h.l.next, b, a.h.B)) : (a.h.B(b), (b = Aa(a)));
      return b;
    };
    this.throw = function (b) {
      pa(a.h);
      a.h.l ? (b = za(a, a.h.l['throw'], b, a.h.B)) : (qa(a.h, b), (b = Aa(a)));
      return b;
    };
  ...
  r('Promise', function (a) {
    ...
    b.prototype.l = function () {
      ...
      var h = this,
        k = !1;
      return { resolve: g(this.xa), reject: g(this.m) };
    };
    ...
    b.prototype.ma = function (g) {
      ...
      'function' == typeof h ? this.jb(h, g) : this.A(g);
    };
    ...
    b.race = function (g) {
      return new b(function (h, k) {
        for (var l = t(g), n = l.next(); !n.done; n = l.next()) d(n.value).oa(h, k);
      });
    };
    b.all = function (g) {
      var h = t(g),
      ...
      return k.done
        ...
        : new b(function (l, n) {
            ...
            var u = [],
              q = 0;
            do u.push(void 0), q++, d(k.value).oa(p(u.length - 1), n), (k = h.next());
            while (!k.done);
          });
    };
    return b;
    ...
    function d(h, k) {
      ...
      if (n && Ea(h.data_, l))
        for (h = 0; h < n.length; h++) {
          var p = n[h];
          if ((k !== k && p.key !== p.key) || k === p.key) return { id: l, list: n, index: h, entry: p };
        }
  ...
  var wb = RegExp(
    ...
    vb = {},
    zb = new ub('about:invalid#zClosurez', vb);
  function Ab() {
    var a = B.navigator;
  ...
  function Bb() {
    return ((H('Chrome') || H('CriOS')) && !H('Edge')) || H('Silk');
  }
  var Cb = {};
  function Db(a, b, c) {
    this.h = c === Cb ? a : '';
  ...
  function Jb(a, b, c) {
    if (Array.isArray(b)) for (var d = 0; d < b.length; d++) Jb(a, String(b[d]), c);
    else null != b && c.push(a + ('' === b ? '' : '=' + encodeURIComponent(String(b))));
  }
  function Lb(a) {
    var b = [],
      c;
    for (c in a) Jb(c, a[c], b);
    return b.join('&');
  }
  var Mb = /#|$/;
  function Nb(a, b) {
  ...
  var Rb = H('Opera'),
    ...
    Ub =
      H('Gecko') &&
      !(-1 != Ab().toLowerCase().indexOf('webkit') && !H('Edge')) &&
      !(H('Trident') || H('MSIE')) &&
      !H('Edge'),
    Vb = -1 != Ab().toLowerCase().indexOf('webkit') && !H('Edge');
  function Wb() {
    var a = B.document;
  ...
  if (B.document && Sb) {
    var cc = Wb();
    bc = cc ? cc : parseInt(ac, 10) || void 0;
  } else bc = void 0;
  var dc = bc;
  var ec = Pb() || H('iPod'),
    fc = H('iPad');
  ...
  var kc = 'function' === typeof Uint8Array;
  ...
  function pc(a) {
    switch (typeof a) {
      ...
      case 'object':
        if (kc && null != a && a instanceof Uint8Array) return jc(a);
    }
    return a;
  }
  function qc(a, b) {
    if (null != a) return Array.isArray(a) || nc(a) ? rc(a, b) : b(a);
  }
  function rc(a, b) {
    if (Array.isArray(a)) {
      for (var c = Array(a.length), d = 0; d < a.length; d++) c[d] = qc(a[d], b);
      if (Array.isArray(a)) {
        var e;
        lc ? (e = a[lc]) : (e = a.h);
        a = !!((null == e ? 0 : e) & 1);
    ...
    e = {};
    for (c in a) e[c] = qc(a[c], b);
    return e;
  }
  function sc(a) {
    a = pc(a);
    return Array.isArray(a) ? rc(a, sc) : a;
  }
  function tc(a) {
    return kc && null != a && a instanceof Uint8Array ? new Uint8Array(a) : a;
  }
  var uc;
  function I(a, b, c) {
    var d = uc;
    ...
    if (c)
      for (b = 0; b < c.length; b++)
        (a = c[b]),
          a < this.l
            ? ((a += this.j), (d = this.H[a]) ? Array.isArray(d) && mc(d) : (this.H[a] = vc))
            : (wc(this), (d = this.i[a]) ? Array.isArray(d) && mc(d) : (this.i[a] = vc));
  }
  var vc = Object.freeze(mc([]));
  function wc(a) {
    var b = a.l + a.j;
    a.H[b] || (a.i = a.H[b] = {});
  }
  ...
  function yc(a, b, c) {
    ...
    var d = xc(a, b, c);
    null == d && (d = vc);
    d === vc && ((d = mc(d.slice())), J(a, b, d, c));
    return d;
  }
  function J(a, b, c, d) {
    (void 0 === d ? 0 : d) || b >= a.l ? (wc(a), (a.i[b] = c)) : (a.H[b + a.j] = c);
    return a;
  }
  function zc(a, b) {
    for (var c = 0, d = 0; d < b.length; d++) {
      var e = b[d];
      null != xc(a, e) && (0 !== c && J(a, c, void 0, !1), (c = e));
    }
    return c;
  }
    ...
    if (c) {
      ...
      for (var d in c) {
        ...
        if (e) {
          ...
          if (Array.isArray(e)) {
            if (e.length)
              for (f = Bc(a, e[0].constructor, g, f), g = 0; g < Math.min(f.length, e.length); g++) Fc(f[g], e[g]);
          } else (f = Ac(a, e.constructor, g, void 0, f)) && Fc(f, e);
        }
      }
    }
  }
  var Gc = window;
  //   kb("csi.gstatic.com");
  //   kb("googleads.g.doubleclick.net");
  //   kb("pagead2.googlesyndication.com");
  //   kb("partner.googleadservices.com");
  //   kb("pubads.g.doubleclick.net");
  //   kb("securepubads.g.doubleclick.net");
  //   kb("tpc.googlesyndication.com");
  /*
...
*/
  ...
  function Kc(a, b, c) {
    var d = arguments,
      ...
      f = d[1],
      g = Lc(e, String(d[0]));
    f && ('string' === typeof f ? (g.className = f) : Array.isArray(f) ? (g.className = f.join(' ')) : Ic(g, f));
    2 < d.length && Mc(e, g, d);
    return g;
  }
  function Mc(a, b, c) {
  ...
  function Xc() {
    ...
    function b(p) {
      for (var u = g, q = 0; 64 > q; q += 4) u[q / 4] = (p[q] << 24) | (p[q + 1] << 16) | (p[q + 2] << 8) | p[q + 3];
      for (q = 16; 80 > q; q++)
        (p = u[q - 3] ^ u[q - 8] ^ u[q - 14] ^ u[q - 16]), (u[q] = ((p << 1) | (p >>> 31)) & 4294967295);
      p = e[0];
      var x = e[1],
        y = e[2],
        A = e[3],
      ...
      for (q = 0; 80 > q; q++) {
        if (40 > q)
          if (20 > q) {
            var N = A ^ (x & (y ^ A));
            var P = 1518500249;
          } else (N = x ^ y ^ A), (P = 1859775393);
        else 60 > q ? ((N = (x & y) | (A & (x | y))), (P = 2400959708)) : ((N = x ^ y ^ A), (P = 3395469782));
        N = ((((p << 5) | (p >>> 27)) & 4294967295) + N + M + P + u[q]) & 4294967295;
        M = A;
        A = y;
    ...
    function c(p, u) {
      ...
      u || (u = p.length);
      q = 0;
      if (0 == l) for (; q + 64 < u; ) b(p.slice(q, q + 64)), (q += 64), (n += 64);
      for (; q < u; )
        if (((f[l++] = p[q++]), n++, 64 == l))
          for (l = 0, b(f); q + 64 < u; ) b(p.slice(q, q + 64)), (q += 64), (n += 64);
    }
    function d() {
      var p = [],
        u = 8 * n;
      ...
      b(f);
      for (q = u = 0; 5 > q; q++) for (var x = 24; 0 <= x; x -= 8) p[u++] = (e[q] >> x) & 255;
      return p;
    }
  ...
  var cd = new bd('undefined' == typeof document ? null : document);
  function dd(a) {
    return !!ad.FPA_SAMESITE_PHASE2_MOD || !(void 0 === a || !a);
  }
  function ed(a, b, c, d) {
    (a = B[a]) || (a = new bd(document).get(b));
    return a ? Yc(a, c, d) : null;
  }
  function fd(a) {
    var b = void 0 === b ? !1 : b;
    var c = Wc(String(B.location.href)),
      d = [];
    var e = b;
    e = void 0 === e ? !1 : e;
    var f = B.__SAPISID || B.__APISID || B.__3PSAPISID || B.__OVERRIDE_SID;
    dd(e) && (f = f || B.__1PSAPISID);
    if (f) e = !0;
    else {
      var g = new bd(document);
      f = g.get('SAPISID') || g.get('APISID') || g.get('__Secure-3PAPISID') || g.get('SID');
      dd(e) && (f = f || g.get('__Secure-1PAPISID'));
      e = !!f;
    }
    e &&
      ((e = (c = 0 == c.indexOf('https:') || 0 == c.indexOf('chrome-extension:') || 0 == c.indexOf('moz-extension:'))
        ? B.__SAPISID
        : B.__APISID),
      e || ((e = new bd(document)), (e = e.get(c ? 'SAPISID' : 'APISID') || e.get('__Secure-3PAPISID'))),
      (e = e ? Yc(e, c ? 'SAPISIDHASH' : 'APISIDHASH', a) : null) && d.push(e),
      c &&
        dd(b) &&
        ((b = ed('__1PSAPISID', '__Secure-1PAPISID', 'SAPISID1PHASH', a)) && d.push(b),
        (a = ed('__3PSAPISID', '__Secure-3PAPISID', 'SAPISID3PHASH', a)) && d.push(a)));
  ...
  var nd = (function () {
    ...
    try {
      B.addEventListener('test', Ia, b), B.removeEventListener('test', Ia, b);
    } catch (c) {}
    return a;
  })();
  function od(a, b) {
  ...
  od.prototype.init = function (a, b) {
    ...
    this.pointerType = 'string' === typeof a.pointerType ? a.pointerType : pd[a.pointerType] || '';
    this.state = a.state;
    this.i = a;
    a.defaultPrevented && od.N.preventDefault.call(this);
  };
  od.prototype.stopPropagation = function () {
    od.N.stopPropagation.call(this);
    this.i.stopPropagation ? this.i.stopPropagation() : (this.i.cancelBubble = !0);
  };
  od.prototype.preventDefault = function () {
    od.N.preventDefault.call(this);
    var a = this.i;
  ...
  ud.prototype.add = function (a, b, c, d, e) {
    ...
    var g = vd(a, b, d, e);
    -1 < g ? ((b = a[g]), c || (b.na = !1)) : ((b = new sd(b, this.src, f, !!d, e)), (b.na = c), a.push(b));
    return b;
  };
  ud.prototype.remove = function (a, b, c, d) {
    ...
    b = vd(e, b, c, d);
    return -1 < b
      ? (td(e[b]), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.listeners[a], this.h--), !0)
      : !1;
  };
  function wd(a, b) {
    var c = b.type;
    c in a.listeners && Xa(a.listeners[c], b) && (td(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.h--));
  }
  function vd(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var f = a[e];
      if (!f.ja && f.listener == b && f.capture == !!c && f.ra == d) return e;
    }
    return -1;
  }
  ...
  function Ad(a, b, c, d, e) {
    ...
    else if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Ad(a, b[f], c, d, e);
    else (c = Cd(c)), a && a[qd] ? a.Y(b, c, D(d) ? !!d.capture : !!d, e) : Dd(a, b, c, !1, d, e);
  }
  ...
  function Bd(a, b, c, d, e) {
    if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Bd(a, b[f], c, d, e);
    else (c = Cd(c)), a && a[qd] ? a.h.add(String(b), c, !0, D(d) ? !!d.capture : !!d, e) : Dd(a, b, c, !0, d, e);
  }
  function Id(a, b, c, d, e) {
    if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Id(a, b[f], c, d, e);
    else
      ((d = D(d) ? !!d.capture : !!d), (c = Cd(c)), a && a[qd])
        ? a.h.remove(String(b), c, d, e)
        : a &&
          (a = Ed(a)) &&
          ((b = a.listeners[b.toString()]), (a = -1), b && (a = vd(b, c, d, e)), (c = -1 < a ? b[a] : null) && Jd(c));
  }
  function Jd(a) {
    if ('number' !== typeof a && a && !a.ja) {
      ...
      if (b && b[qd]) wd(b.h, a);
        ...
        zd--;
        (c = Ed(b)) ? (wd(c, a), 0 == c.h && ((c.src = null), (b[xd] = null))) : td(a);
      }
    }
  }
  function Gd(a) {
  ...
  function Ld(a, b) {
    ...
    b.j || ((g = b.h = a), (e = Md(g, c, !0, b) && e), b.j || (e = Md(g, c, !1, b) && e));
    if (d) for (f = 0; !b.j && f < d.length; f++) (g = b.h = d[f]), (e = Md(g, c, !1, b) && e);
  }
  K.prototype.fa = function () {
    ...
    if (this.h) {
      ...
      for (c in a.listeners) {
        for (var d = a.listeners[c], e = 0; e < d.length; e++) ++b, td(d[e]);
  ...
  K.prototype.Y = function (a, b, c, d) {
  ...
  function Nd(a) {
    ...
    this.i =
      null !== (c = null === (b = window.navigator) || void 0 === b ? void 0 : b.onLine) && void 0 !== c ? c : !0;
    this.m = function () {
      return z(function (e) {
        return w(e, Od(d), 0);
      });
          ...
          return z(function (g) {
            switch (g.h) {
              ...
              case 3:
                ...
                a.u = void 0;
                a.j && (a.K.W(a.j), (a.j = 0));
                f !== a.i && ((a.i = f), a.i ? Ld(a, 'networkstatus-online') : Ld(a, 'networkstatus-offline'));
                c(f);
                wa(g);
                break;
              case 2:
  ...
  function ce() {
    if (B.Promise && B.Promise.resolve) {
      ...
      be = function () {
        ...
        (B.Window && B.Window.prototype && !H('Edge') && B.Window.prototype.setImmediate == B.setImmediate)
          ? (Vd || (Vd = Xd()), Vd(b))
          : B.setImmediate(b);
      };
  }
  ...
  je.prototype.update = function (a, b) {
    if (null != a) {
      ...
      for (var c = b - this.blockSize, d = 0, e = this.m, f = this.i; d < b; ) {
        if (0 == f) for (; d <= c; ) ke(this, a, d), (d += this.blockSize);
        if ('string' === typeof a)
          for (; d < b; ) {
  ...
  var le = 'StopIteration' in B ? B.StopIteration : { message: 'StopIteration', stack: '' };
  function me() {}
  ...
  function qe(a) {
    if (a instanceof re || a instanceof se || a instanceof te) return a;
  ...
  function ve(a, b) {
    ...
    if (1 < c) {
      ...
      if (a instanceof ve) for (c = we(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
  ...
  m.delete = function (a) {
    return ye(this.i, a)
      ? (delete this.i[a], --this.size, this.j++, this.h.length > 2 * this.size && xe(this), !0)
      : !1;
  };
  function xe(a) {
    ...
    if (a.size != a.h.length) {
      var e = {};
      for (c = b = 0; b < a.h.length; ) (d = a.h[b]), ye(e, d) || ((a.h[c++] = d), (e[d] = 1)), b++;
      a.h.length = c;
    }
  }
  m.get = function (a, b) {
    return ye(this.i, a) ? this.i[a] : b;
  };
  m.set = function (a, b) {
    ye(this.i, a) || ((this.size += 1), this.h.push(a), this.j++);
    this.i[a] = b;
  };
  ...
  m.keys = function () {
    return qe(this.J(!0)).i();
  };
  m.values = function () {
    return qe(this.J(!1)).i();
  };
  m.entries = function () {
    var a = this;
    return he(this.keys(), function (b) {
      return [b, a.get(b)];
    });
  };
  m.J = function (a) {
      ...
      if (a.j) {
        ...
        if (c.i) {
          ...
          e &&
            (0 == c.h && 1 == d
              ? Je(c, b)
              : (f ? ((d = f), d.next == c.l && (c.l = d), (d.next = d.next.next)) : Ke(c), Le(c, e, 3, b)));
        }
        a.j = null;
      } else De(a, 3, b);
  }
  function Me(a, b) {
    a.i || (2 != a.h && 3 != a.h) || Ne(a);
    a.l ? (a.l.next = b) : (a.i = b);
    a.l = b;
  }
  function He(a, b, c, d) {
    var e = Ge(null, null, null);
    e.h = new Ce(function (f, g) {
      e.i = b
        ? function (h) {
            try {
              var k = b.call(d, h);
  ...
  function De(a, b, c) {
    if (0 == a.h) {
      ...
      g || ((a.u = c), (a.h = b), (a.j = null), Ne(a), 3 != b || c instanceof Ie || Pe(a, c));
    }
  }
  ...
  Ce.prototype.B = function () {
    for (var a; (a = Ke(this)); ) Le(this, a, this.h, this.u);
    this.A = !1;
  };
  function Le(a, b, c, d) {
    if (3 == c && b.onRejected && !b.j) for (; a && a.m; a = a.j) a.m = !1;
    if (b.h) (b.h.j = null), Qe(b, c, d);
    else
      try {
        b.j ? b.i.call(b.context) : Qe(b, c, d);
      } catch (e) {
        Re.call(null, e);
      }
    Ud(Fe, b);
  ...
  m.la = function (a) {
    ...
    if (b) {
      var c = this.i[b];
      0 != this.m
        ? (this.j.push(a), (this.h[a + 1] = Ia))
        : (c && Xa(c, a), delete this.h[a], delete this.h[a + 1], delete this.h[a + 2]);
    }
    return !!b;
  };
  m.ca = function (a, b) {
    ...
    if (c) {
      ...
      if (this.B)
        ...
        try {
          ...
          if ((this.m--, 0 < this.j.length && 0 == this.m)) for (; (c = this.j.pop()); ) this.la(c);
        }
      }
      return 0 != e;
    }
  ...
  m.clear = function (a) {
    if (a) {
      var b = this.i[a];
      b && (b.forEach(this.la, this), delete this.i[a]);
  ...
  Ve.prototype.set = function (a, b) {
    void 0 === b ? this.h.remove(a) : this.h.set(a, Ae(b));
  };
  ...
  We.prototype.set = function (a, b) {
    We.N.set.call(this, a, Ye(b));
  };
  We.prototype.i = function (a) {
    a = We.N.get.call(this, a);
  ...
  Ze.prototype.set = function (a, b, c) {
    ...
    Ze.N.set.call(this, a, b);
  };
  Ze.prototype.i = function (a) {
    var b = Ze.N.i.call(this, a);
    if (b) {
      var c = b.creation,
        d = b.expiration;
  ...
  m.J = function (a) {
    ...
    d.next = function () {
      if (b >= c.length) return ne;
      var f = c[b++];
      if (a) return oe(decodeURIComponent(f.nodeName.replace(/\./g, '%')).substr(1));
      f = f.nodeValue;
      if ('string' !== typeof f) throw 'Storage mechanism: Invalid value was encountered';
      return oe(f);
    };
  ...
  jf.prototype.J = function (a) {
    ...
    d.next = function () {
      ...
      return oe(a ? f.substr(c.h.length) : c.i.get(f));
    };
    var e = d.next;
    d.P = function () {
      return pe(e.call(d));
  ...
  kf.prototype.X = function () {
    return xc(this, 2 === zc(this, lf) ? 2 : -1);
  };
  kf.prototype.setValue = function (a) {
    var b = zc(this, lf);
    b && 2 !== b && null != a && (this.h && b in this.h && (this.h[b] = void 0), J(this, b, void 0));
    return J(this, 2, a);
  };
  var lf = [2, 3, 4, 5, 6];
  function mf(a) {
  ...
  v(pf, I);
  pf.prototype.getPlayerType = function () {
    return xc(this, 36);
  };
  pf.prototype.setHomeGroupInfo = function (a) {
    return Cc(this, 81, a);
  };
  var qf = [9, 66, 24, 32, 86, 100, 101];
  function rf(a) {
    I.call(this, a, -1, sf);
  }
  v(rf, I);
  ...
  v(tf, I);
  tf.prototype.setToken = function (a) {
    return J(this, 2, a);
  };
  function uf(a) {
    I.call(this, a, -1, vf);
  ...
  v(uf, I);
  uf.prototype.setSafetyMode = function (a) {
    return J(this, 5, a);
  };
  var vf = [12];
  function wf(a) {
  ...
  var Ef,
    ...
    Hf = B.window,
    If =
      (null === (Ef = null === Hf || void 0 === Hf ? void 0 : Hf.yt) || void 0 === Ef ? void 0 : Ef.config_) ||
      (null === (Ff = null === Hf || void 0 === Hf ? void 0 : Hf.ytcfg) || void 0 === Ff ? void 0 : Ff.data_) ||
      {},
    Jf =
      (null === (Gf = null === Hf || void 0 === Hf ? void 0 : Hf.ytcfg) || void 0 === Gf
        ? void 0
        : Gf.obfuscatedData_) || [];
  function Kf() {
  ...
  function Lf() {
    var a = arguments;
    1 < a.length ? (If[a[0]] = a[1]) : 1 === a.length && Object.assign(If, a[0]);
  }
  function O(a, b) {
    return a in If ? If[a] : b;
  }
  function Mf() {
    return O('LATEST_ECATCHER_SERVICE_TRACKING_PARAMS', void 0);
  }
  var Nf = [];
  function Of(a) {
  ...
  function Qf(a, b, c, d) {
    ...
    e ? e(a, 'ERROR', b, c, d) : ((e = O('ERRORS', [])), e.push([a, 'ERROR', b, c, d]), Lf('ERRORS', e));
    Of(a);
  }
  function Rf(a, b, c, d) {
    var e = C('yt.logging.errors.log');
    e ? e(a, 'WARNING', b, c, d) : ((e = O('ERRORS', [])), e.push([a, 'WARNING', b, c, d]), Lf('ERRORS', e));
  }
  var Sf = 0;
  E(
    'ytDomDomGetNextId',
  ...
  function Uf(a) {
    ...
    try {
      if ((a = a || window.event)) {
        this.event = a;
        for (var b in a) b in Tf || (this[b] = a[b]);
        this.scale = a.scale;
  ...
  Uf.prototype.stopImmediatePropagation = function () {
    this.event &&
      ((this.event.cancelBubble = !0), this.event.stopImmediatePropagation && this.event.stopImmediatePropagation());
  };
  var cb = B.ytEventsEventsListeners || {};
  E('ytEventsEventsListeners', cb);
  var Vf = B.ytEventsEventsCounter || { count: 0 };
  E('ytEventsEventsCounter', Vf);
  function Wf(a, b, c, d) {
    d = void 0 === d ? {} : d;
    a.addEventListener &&
      ...
      if (!e) {
        ...
        a.addEventListener
          ? ('mouseenter' == b && f
              ...
              ? (b = 'mouseout')
              : 'mousewheel' == b && 'MozBoxSizing' in document.documentElement.style && (b = 'MozMousePixelScroll'),
            Yf() || 'boolean' === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture))
          ...
          k.args = [
            {
              ...
              value: f[1],
              query: a,
              method: fg == n ? 'unchanged' : n
            }
          ];
          cg.hasOwnProperty(l) || Rf(k);
        }
    }
    return c;
  }
  ...
  function jg(a) {
    ...
    var c = a.match(Fb)[1] || null,
      d = Hb(a);
    c && d
      ? ((a = a.match(Fb)), (b = b.match(Fb)), (a = a[3] == b[3] && a[1] == b[1] && a[4] == b[4]))
      : (a = d
          ? Hb(b) == d && (Number(b.match(Fb)[4] || null) || null) == (Number(a.match(Fb)[4] || null) || null)
          : !0);
    return a;
  }
  function eg(a) {
  ...
  function mg() {
    ...
    var c = O('EXPERIMENT_FLAGS', {});
    for (var d in c) d.startsWith('force_') && void 0 === b[d] && a.push({ key: d, value: String(c[d]) });
    return a;
  }
  var ng = {
    Nb: 'WEB_DISPLAY_MODE_UNKNOWN',
    Jb: 'WEB_DISPLAY_MODE_BROWSER',
    Lb: 'WEB_DISPLAY_MODE_MINIMAL_UI',
    Mb: 'WEB_DISPLAY_MODE_STANDALONE',
    Kb: 'WEB_DISPLAY_MODE_FULLSCREEN'
  };
  var og = {
  ...
  function xg(a) {
    ...
    try {
      ...
      e.u_his = h;
      var k;
      e.u_h = null == (k = Gc.screen) ? void 0 : k.height;
      var l;
      e.u_w = null == (l = Gc.screen) ? void 0 : l.width;
      var n;
      e.u_ah = null == (n = Gc.screen) ? void 0 : n.availHeight;
      var p;
      e.u_aw = null == (p = Gc.screen) ? void 0 : p.availWidth;
      var u;
      e.u_cd = null == (u = Gc.screen) ? void 0 : u.colorDepth;
    } catch (ta) {}
    h = b.h;
    try {
      var q = h.screenX;
    ...
    try {
      (M = h.innerWidth), (N = h.innerHeight);
    } catch (ta) {}
    try {
      var Wd = h.screen.availWidth;
      var Pj = h.screen.availTop;
    } catch (ta) {}
    q = [P, Kb, q, x, Wd, Pj, y, A, M, N];
    x = b.h.top;
    try {
      var Z = (x || window).document,
        V = 'CSS1Compat' == Z.compatMode ? Z.documentElement : Z.body;
      var ja = new Hc(V.clientWidth, V.clientHeight).round();
    } catch (ta) {
      ja = new Hc(-12245933, -12245933);
    }
    Z = ja;
    ja = {};
    V = new Qd();
    B.SVGElement && B.document.createElementNS && V.set(0);
    x = Sc();
    x['allow-top-navigation-by-user-activation'] && V.set(1);
    x['allow-popups-to-escape-sandbox'] && V.set(2);
    B.crypto && B.crypto.subtle && V.set(3);
    B.TextDecoder && B.TextEncoder && V.set(4);
    V = Rd(V);
    ja.bc = V;
    ja.bih = Z.height;
    ja.biw = Z.width;
    ...
    b = b.i;
    Z = 'Da';
    Sd.Da && Sd.hasOwnProperty(Z) ? (Z = Sd.Da) : ((V = new Sd()), (Sd.Da = V), Sd.hasOwnProperty(Z), (Z = V));
    b =
      ((ja.vis =
        Z.v(Vc.flag, Vc.defaultValue) && b.prerendering
          ? 3
          : { visible: 1, hidden: 2, prerender: 3, preview: 4, unloaded: 5 }[
              b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ''
            ] || 0),
      (ja.wgl = !!Gc.WebGLRenderingContext),
      ja);
    c = d.call(c, e, b);
    c.ca_type = 'image';
    a && (c.bid = a);
  ...
  function Eg(a, b) {
    ...
    for (e in Bg) {
      var f = O(Bg[e]);
      !f || (!c && Hb(a)) || (d && void 0 !== b[e]) || (b[e] = f);
    }
    if (c || !Hb(a)) b['X-YouTube-Utc-Offset'] = String(-new Date().getTimezoneOffset());
    if (c || !Hb(a)) {
      try {
    ...
    if (c || !Hb(a)) b['X-YouTube-Ad-Signals'] = gg(xg(void 0));
    return b;
  }
  function Fg(a) {
    var b = window.location.search,
      c = Hb(a);
    Q('debug_handle_relative_url_for_query_forward_killswitch') || c || !jg(a) || (c = document.location.hostname);
    var d = Gb(a.match(Fb)[5] || null);
      ...
      f = Jg(
        ...
        function (k) {
          if (!e) {
            ...
            if (l || p || u) n = Kg(a, c, k, b.convertToSafeHtml);
            if (l)
  ...
  function Hg(a, b) {
    ...
    if ((b = b.urlParams)) b[c] && delete b[c], (a = ig(a, b || {}, !0));
    return a;
  }
  function Ig(a, b) {
    var c = O('XSRF_FIELD_NAME', void 0),
    ...
    b.excludeXsrf ||
      (Hb(a) && !b.withCredentials && Hb(a) != document.location.hostname) ||
      'POST' != b.method ||
    ...
    f &&
      'string' === typeof e &&
      ((e = hg(e)), gb(e, f), (e = b.postBodyFormat && 'JSON' == b.postBodyFormat ? JSON.stringify(e) : Lb(e)));
    if (!(a = e) && (a = f)) {
      a: {
        for (var k in f) {
          f = !1;
    ...
    !Dg && a && 'POST' != b.method && ((Dg = !0), Qf(Error('AJAX request with postData should use POST')));
    return e;
  }
  function Kg(a, b, c, d) {
    var e = null;
  ...
  function Ng(a) {
    if (D(a))
      for (var b in a) {
        ...
        if (c) {
          c = b;
          kb('HTML that is escaped and sanitized server-side and passed through yt.net.ajax');
          var d = Eb(a[b], null);
          a[c] = d;
        } else Ng(a[b]);
      }
  ...
  function Jg(a, b, c, d, e, f, g) {
    ...
    Q('debug_forward_web_query_parameters') && (a = Fg(a));
    k.open(c, a, !0);
    f && (k.responseType = f);
    g && (k.withCredentials = !0);
    c = 'POST' == c && (void 0 === window.FormData || !(d instanceof FormData));
    if ((e = Eg(a, e))) for (var l in e) k.setRequestHeader(l, e[l]), 'content-type' == l.toLowerCase() && (c = !1);
  ...
  function Sg(a, b, c, d, e) {
    ...
    if (a)
      if (c && !Pg('cobalt'))
        a &&
          (a instanceof ub ||
            ((a = 'object' == typeof a && a.ha ? a.ga() : String(a)),
            yb.test(a)
              ? (a = new ub(a, vb))
              : ((a = String(a)),
                (a = a.replace(/(%0A|%0D)/g, '')),
                (a = (b = a.match(xb)) && wb.test(b[1]) ? new ub(a, vb) : null))),
          (a = a || zb),
          a instanceof ub && a.constructor === ub ? (a = a.h) : (Ja(a), (a = 'type_error:SafeUrl')),
          'about:invalid#zClosurez' === a || a.startsWith('data')
            ...
            : (a instanceof Db ||
                ...
                (c = null),
                b && a.Sa && (c = a.Qa()),
                (a = Eb(mb(b && a.ha ? a.ga() : String(a)), c))),
              a instanceof Db && a.constructor === Db ? (a = a.h) : (Ja(a), (a = 'type_error:SafeHtml')),
              (a = encodeURIComponent(String(Ae(a.toString()))))),
          /^[\s\xa0]*$/.test(a) ||
            ((a = Kc('IFRAME', {
      ...
      else if (e) Jg(a, b, 'POST', e, d);
      else if (O('USE_NET_AJAX_FOR_PING_TRANSPORT', !1) || d) Jg(a, b, 'GET', '', d);
      else {
        b: {
          try {
            var f = new Ta({ url: a });
            if ((f.j && f.i) || f.l) {
              var g = Gb(a.match(Fb)[5] || null);
              var h = !(!g || !g.endsWith('/aclk') || '1' !== Nb(a, 'ri'));
              break b;
            }
          } catch (k) {}
          h = !1;
        }
        h ? (Tg(a) ? (b && b(), (c = !0)) : (c = !1)) : (c = !1);
        c || Ug(a, b);
      }
  }
  function Vg() {
    var a = void 0 === a ? '' : a;
    Tg('/generate_204', a) || Sg('/generate_204', void 0, void 0, void 0, a);
  }
  function Tg(a, b) {
    try {
  ...
  var Wg = B.ytPubsubPubsubInstance || new L(),
    Xg = B.ytPubsubPubsubSubscribedKeys || {},
    Yg = B.ytPubsubPubsubTopicToKeys || {},
    Zg = B.ytPubsubPubsubIsSynchronous || {};
  ...
  E('ytPubsubPubsubInstance', Wg);
  E('ytPubsubPubsubTopicToKeys', Yg);
  E('ytPubsubPubsubIsSynchronous', Zg);
  E('ytPubsubPubsubSubscribedKeys', Xg);
  var $g = window,
    R =
      $g.ytcsi && $g.ytcsi.now
        ? $g.ytcsi.now
        : $g.performance && $g.performance.timing && $g.performance.now && $g.performance.timing.navigationStart
        ? function () {
  ...
  var ah = lg('initial_gel_batch_timeout', 2e3),
    bh = Math.pow(2, 16) - 1,
    ch = void 0;
  function dh() {
  ...
  E('ytLoggingTransportGELQueue_', hh);
  var ih = B.ytLoggingTransportGELProtoQueue_ || new Map();
  E('ytLoggingTransportGELProtoQueue_', ih);
  var jh = B.ytLoggingTransportTokensToCttTargetIds_ || {};
  E('ytLoggingTransportTokensToCttTargetIds_', jh);
  var kh = B.ytLoggingTransportTokensToJspbCttTargetIds_ || {};
  E('ytLoggingTransportTokensToJspbCttTargetIds_', kh);
  function lh(a, b) {
    if ('log_event' === a.endpoint) {
      ...
      var e = void 0 === e ? !1 : e;
      b && (ch = new b());
      a = lg('tvhtml5_logging_max_batch') || lg('web_logging_max_batch') || 100;
      b = R();
      var f = e ? fh.j : eh.j;
      d.length >= a
        ? nh({ writeThenSend: !0 }, Q('flush_only_full_queue') ? c : void 0, e)
  ...
  function mh(a) {
    var b = '';
    if (a.za) b = 'visitorOnlyApprovedKey';
    else if (a.da) {
      b = a.da;
      var c = {};
  ...
  function oh(a) {
    a = void 0 === a ? !1 : a;
    if (Q('web_gel_timeout_cap') && ((!a && !eh.h) || (a && !fh.h))) {
      var b = $f(function () {
    ...
    b = O('LOGGING_BATCH_TIMEOUT', lg('web_gel_debounce_ms', 1e4));
    Q('shorten_initial_gel_batch_timeout') && gh && (b = ah);
    b = $f(function () {
      nh({ writeThenSend: !0 }, void 0, a);
    }, b);
    a ? (fh.i = b) : (eh.i = b);
  ...
  function qh(a, b, c, d) {
    ...
    for (var h = a.next(); !h.done; h = a.next()) {
      ...
      vh(k, f, h);
      wh(c);
      Q('send_beacon_before_gel') && window.navigator && window.navigator.sendBeacon && !c.writeThenSend && Vg();
      xh(
        e,
        'log_event',
        k,
  ...
  function rh(a, b, c) {
    ...
    for (var g = a.next(); !g.done; g = a.next()) {
      ...
      Cc(h, 1, l);
      for (l = 0; l < k.length; l++) Dc(h, 3, k[l], yf);
      (k = kh[g]) && Ah(h, g, k);
      delete kh[g];
      ...
      a: {
        oc = !0;
        try {
          var n = JSON.stringify(h.toJSON(), Ec);
          break a;
        } finally {
          oc = !1;
        }
  ...
  function Ch() {
    var a = O('BATCH_CLIENT_COUNTER', void 0) || 0;
    a || (a = Math.floor((Math.random() * bh) / 2));
    a++;
    a > bh && (a = 1);
    Lf('BATCH_CLIENT_COUNTER', a);
    return a;
  }
  function uh(a, b, c) {
  ...
  var Dh = B.ytLoggingGelSequenceIdObj_ || {};
  E('ytLoggingGelSequenceIdObj_', Dh);
  function Eh() {
  ...
  function th() {
    return {
      ...
      pb: O('INNERTUBE_CONTEXT_CLIENT_NAME', 1),
      ...
      qb: O('INNERTUBE_HOST_OVERRIDE', void 0) || '',
      sb: !!O('INNERTUBE_USE_THIRD_PARTY_AUTH', !1),
      rb: !!O('INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT', !1),
  ...
  function sh(a) {
    ...
    Ph(a, void 0, b);
    Qh(void 0, b);
    O('DELEGATED_SESSION_ID') && !Q('pageid_as_header_web') && (b.user = { onBehalfOfUser: O('DELEGATED_SESSION_ID') });
    a = Object;
    c = a.assign;
    for (var d = b.client, e = {}, f = t(Object.entries(hg(O('DEVICE', '')))), g = f.next(); !g.done; g = f.next()) {
      var h = t(g.value);
      g = h.next().value;
      h = h.next().value;
      'cbrand' === g
  ...
  function zh(a) {
    ...
    (d = B.devicePixelRatio) && 1 != d && J(c, 65, d);
    ...
    Ph(a, c);
    Qh(c);
    O('DELEGATED_SESSION_ID') && !Q('pageid_as_header_web') && ((a = new uf()), J(a, 3, O('DELEGATED_SESSION_ID')));
    a = t(Object.entries(hg(O('DEVICE', ''))));
  ...
  function Mh(a, b, c) {
    ...
    if ('WEB' === a || 'MWEB' === a || 1 === a || 2 === a)
      if (b) {
        ...
        c &&
          ((c.client.mainAppWebInfo = null != (d = c.client.mainAppWebInfo) ? d : {}),
          (c.client.mainAppWebInfo.webDisplayMode = Eh()));
  }
  function Nh(a, b, c) {
    a = a.Ca;
    if (('WEB_REMIX' === a || 76 === a) && !Q('music_web_display_mode_killswitch'))
      if (b) {
        var d;
        c = null != (d = Ac(b, of, 70)) ? d : new of();
        d = Fh();
        null !== d && J(c, 10, d);
        Cc(b, 70, c);
      } else if (c) {
        var e;
        c.client.Wa = null != (e = c.client.Wa) ? e : {};
        c.client.Wa.webDisplayMode = Eh();
      }
  }
  function Oh(a, b) {
    var c;
    if (Q('web_log_memory_total_kbytes') && (null == (c = B.navigator) ? 0 : c.deviceMemory)) {
      var d;
  ...
  function Ph(a, b, c) {
    if (a.appInstallData)
      if (b) {
        var d;
        c = null != (d = Ac(b, mf, 62)) ? d : new mf();
        J(c, 6, a.appInstallData);
        Cc(b, 62, c);
      } else
        c &&
          ((c.client.configInfo = c.client.configInfo || {}), (c.client.configInfo.appInstallData = a.appInstallData));
  }
  function Qh(a, b) {
    a: {
      var c = Kh();
      if (c) {
        var d = Gh[c.type || 'unknown'] || 'CONN_UNKNOWN';
        c = Gh[c.effectiveType || 'unknown'] || 'CONN_UNKNOWN';
    ...
    d && (a ? J(a, 61, Hh[d]) : b && (b.client.connectionType = d));
    Q('web_log_effective_connection_type') &&
      ((d = Kh()),
      (d =
        null !== d && void 0 !== d && d.effectiveType
          ? Jh.hasOwnProperty(d.effectiveType)
            ? Jh[d.effectiveType]
            : 'EFFECTIVE_CONNECTION_TYPE_UNKNOWN'
          : void 0),
      d && (a ? J(a, 94, Ih[d]) : b && (b.client.effectiveConnectionType = d)));
  }
  function Rh(a, b, c) {
    c = void 0 === c ? {} : c;
    var d = { 'X-Goog-Visitor-Id': c.visitorData || O('VISITOR_DATA', '') };
    if (b && b.includes('www.youtube-nocookie.com')) return d;
    (b = c.Pb || O('AUTHORIZATION')) || (a ? (b = 'Bearer ' + C('gapi.auth.getToken')().Ob) : (b = fd([])));
    b &&
      ((d.Authorization = b),
      (d['X-Goog-AuthUser'] = O('SESSION_INDEX', 0)),
      Q('pageid_as_header_web') && (d['X-Goog-PageId'] = O('DELEGATED_SESSION_ID')));
    return d;
  }
  function Sh(a) {
    a = Object.assign({}, a);
    ...
    if (b) {
      ...
      c.update(b);
      a.hash = jc(c.digest(), 3);
    }
    return a;
  }
  function Th(a) {
    var b = new cf();
    (b = b.isAvailable() ? (a ? new jf(b, a) : b) : null) ||
      ((a = new df(a || 'UserDataSharedStore')), (b = a.isAvailable() ? a : null));
  ...
  Th.prototype.get = function (a, b) {
    ...
    if (d && (c = cd.get('' + a, void 0)) && ((c = unescape(c)), b))
      try {
        c = JSON.parse(c);
      } catch (e) {
  ...
  Th.prototype.remove = function (a) {
    ...
    var b = this.i;
    cd.remove('' + a, '/', void 0 === b ? 'youtube.com' : b);
  };
  var Uh;
  function Vh() {
      ...
      for (var c in b) {
        ...
        if (!(6e4 > Math.round(R()) - d.requestTime)) {
          var e = d.authState,
            f = Sh(Rh(!1));
          db(e, f) &&
            ((e = d.request), 'requestTimeMs' in e && (e.requestTimeMs = Math.round(R())), xh(a, d.method, e, {}));
          delete b[c];
        }
      }
      Vh().set('requests', b, 86400, !0);
  ...
  function $h() {
    var a;
    return null === (a = Zh()) || void 0 === a ? void 0 : a.get('LAST_RESULT_ENTRY_KEY', !0);
  }
  var ai = [],
    bi = !1;
  function ci(a) {
    bi || (ai.push({ type: 'ERROR', payload: a }), 10 < ai.length && ai.shift());
  }
  function di(a, b) {
    bi || (ai.push({ type: 'EVENT', eventType: a, payload: b }), 10 < ai.length && ai.shift());
  }
  function ei(a) {
  ...
  function gi() {
    if (void 0 !== O('DATASYNC_ID', void 0)) return O('DATASYNC_ID', void 0);
    throw new ei('Datasync ID not set', 'unknown');
  }
  function hi(a) {
  ...
  var ji = {},
    ki =
      ((ji.AUTH_INVALID = 'No user identifier specified.'),
      (ji.EXPLICIT_ABORT = 'Transaction was explicitly aborted.'),
      (ji.IDB_NOT_SUPPORTED = 'IndexedDB is not supported.'),
      (ji.MISSING_INDEX = 'Index not created.'),
      (ji.MISSING_OBJECT_STORES = 'Object stores not created.'),
      (ji.DB_DELETED_BY_MISSING_OBJECT_STORES = 'Database is deleted because expected object stores were not created.'),
      (ji.UNKNOWN_ABORT = 'Transaction was aborted for unknown reasons.'),
      (ji.QUOTA_EXCEEDED = 'The current transaction exceeded its quota limitations.'),
      (ji.QUOTA_MAYBE_EXCEEDED = 'The current transaction may have failed because of exceeding quota limitations.'),
      (ji.EXECUTE_TRANSACTION_ON_CLOSED_DB = "Can't start a transaction on a closed database"),
      (ji.INCOMPATIBLE_DB_VERSION = 'The binary is incompatible with the database version'),
      ji),
    li = {},
    mi =
      ((li.AUTH_INVALID = 'ERROR'),
      (li.EXECUTE_TRANSACTION_ON_CLOSED_DB = 'WARNING'),
      (li.EXPLICIT_ABORT = 'IGNORED'),
      (li.IDB_NOT_SUPPORTED = 'ERROR'),
      (li.MISSING_INDEX = 'WARNING'),
      (li.MISSING_OBJECT_STORES = 'ERROR'),
      (li.DB_DELETED_BY_MISSING_OBJECT_STORES = 'WARNING'),
      (li.QUOTA_EXCEEDED = 'WARNING'),
      (li.QUOTA_MAYBE_EXCEEDED = 'WARNING'),
      (li.UNKNOWN_ABORT = 'WARNING'),
      (li.INCOMPATIBLE_DB_VERSION = 'WARNING'),
      li),
    ni = {},
    oi =
      ((ni.AUTH_INVALID = !1),
      (ni.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1),
      (ni.EXPLICIT_ABORT = !1),
      (ni.IDB_NOT_SUPPORTED = !1),
      (ni.MISSING_INDEX = !1),
      (ni.MISSING_OBJECT_STORES = !1),
      (ni.DB_DELETED_BY_MISSING_OBJECT_STORES = !1),
      (ni.QUOTA_EXCEEDED = !1),
      (ni.QUOTA_MAYBE_EXCEEDED = !0),
      (ni.UNKNOWN_ABORT = !0),
      (ni.INCOMPATIBLE_DB_VERSION = !1),
      ni);
  ...
  v(S, ei);
  function pi(a, b) {
    S.call(this, 'MISSING_OBJECT_STORES', { expectedObjectStores: b, foundObjectStores: a }, ki.MISSING_OBJECT_STORES);
  ...
  function si(a, b, c, d) {
    ...
    if (gc && 'UnknownError' === e.name) return new S('QUOTA_MAYBE_EXCEEDED', a);
    if (e instanceof qi)
      return new S(
        'MISSING_INDEX',
    ...
    e.args = [Object.assign(Object.assign({}, a), { name: 'IdbError', Wb: e.name })];
    e.level = 'WARNING';
    return e;
  }
  function ti(a, b, c) {
  ...
  T.prototype.then = function (a, b) {
    var c = this,
      d = null !== a && void 0 !== a ? a : vi,
      e = null !== b && void 0 !== b ? b : ui;
    return new T(
      new wi(function (f, g) {
        'PENDING' === c.state.status
          ...
          ? yi(c, c, d, f, g)
          : 'REJECTED' === c.state.status && zi(c, c, e, f, g);
      })
    );
  };
  function xi(a, b) {
  ...
  function yi(a, b, c, d, e) {
    try {
      ...
      f instanceof T ? Ai(a, b, f, d, e) : d(f);
    } catch (g) {
      e(g);
    }
  }
  ...
  m.add = function (a, b, c) {
    return W(this, [a], { mode: 'readwrite', G: !0 }, function (d) {
      return d.objectStore(a).add(b, c);
    });
  };
  m.clear = function (a) {
    return W(this, [a], { mode: 'readwrite', G: !0 }, function (b) {
  ...
  m.count = function (a, b) {
    return W(this, [a], { mode: 'readonly', G: !0 }, function (c) {
  ...
  m.delete = function (a, b) {
    return W(this, [a], { mode: 'readwrite', G: !0 }, function (c) {
  ...
  function Hi(a, b) {
    return W(a, ['LogsRequestsStore'], { mode: 'readwrite', G: !0 }, function (c) {
      c = c.objectStore('LogsRequestsStore');
      return U(c.h.put(b, void 0));
    });
  }
    ...
    return z(function (A) {
      switch (A.h) {
        ...
        case 2:
          ...
          return w(A, M, 6);
        case 6:
          return (n = A.i), (p = Math.round(R())), Ki(a, k, p, g, void 0, b.join(), e), A.return(n);
        case 4:
          u = ua(A);
          q = Math.round(R());
          x = si(u, a.h.name, b.join(), a.h.version);
          if ((y = x instanceof S && !x.h) || g >= f) Ki(a, k, q, g, x, b.join(), e), (h = x);
          A.o(2);
          break;
        case 3:
    ...
    e
      ? (e instanceof S &&
        ...
        e instanceof S &&
          ...
          di('TRANSACTION_UNEXPECTEDLY_ABORTED', {
            objectStoreNames: f,
  ...
  function Mi(a, b) {
    return Ni(a, { query: b }, function (c) {
  ...
  m.delete = function (a) {
    return a instanceof IDBKeyRange ? Mi(this, a) : U(this.h.delete(a));
  };
  m.get = function (a) {
  ...
  m.index = function (a) {
    try {
      ...
      if (b instanceof Error && 'NotFoundError' === b.name) throw new qi(a, this.h.name);
      throw b;
    }
  };
  m.getName = function () {
  ...
  Ii.prototype.objectStore = function (a) {
    a = this.h.objectStore(a);
    var b = this.j.get(a);
    b || ((b = new Gi(a)), this.j.set(a, b));
    return b;
  };
  function Oi(a) {
    this.h = a;
  ...
  m.delete = function (a) {
    return Qi(this, { query: a }, function (b) {
    ...
    return new Promise(function (d, e) {
      ...
      g.addEventListener('upgradeneeded', function (q) {
        try {
          ...
          q.dataLoss &&
            'none' !== q.dataLoss &&
            di('IDB_DATA_CORRUPTED', {
              reason: q.dataLossMessage || 'unknown reason',
              dbName: ii(a)
            });
          var x = f(),
            y = new Ii(g.transaction);
          n &&
            n(
              x,
              function (A) {
  ...
  function Yi(a, b) {
    if (!b) throw ti('openWithToken', ii(a.name));
    return a.open();
  }
  Wi.prototype.open = function () {
    function a() {
      var f, g, h, k, l, n, p, u, q, x;
      return z(function (y) {
        switch (y.h) {
          case 1:
            return (
          ...
          case 4:
            k = y.i;
            for (var A = c.options, M = [], N = t(Object.keys(A.ia)), P = N.next(); !P.done; P = N.next()) {
              P = P.value;
              var Kb = A.ia[P],
                Wd = void 0 === Kb.vb ? Number.MAX_VALUE : Kb.vb;
              !(k.h.version >= Kb.ya) || k.h.version >= Wd || k.h.objectStoreNames.contains(P) || M.push(P);
            }
            l = M;
            if (0 === l.length) {
              y.o(5);
            ...
            n = Object.keys(c.options.ia);
            p = k.objectStoreNames();
            if (!(c.m < lg('ytidb_remake_db_retries', 1))) {
              y.o(6);
              break;
            }
            c.m++;
          ...
          case 2:
            ...
            if (
              u instanceof DOMException
                ? 'VersionError' !== u.name
                : 'DOMError' in self && u instanceof DOMError
                ? 'VersionError' !== u.name
                : !(u instanceof Object && 'message' in u) ||
            ...
            return w(y, c.j(c.name, void 0, Object.assign(Object.assign({}, e), { upgrade: void 0 })), 11);
          case 11:
            q = y.i;
            x = q.h.version;
            if (void 0 !== c.options.version && x > c.options.version + 1) throw (q.close(), (c.l = !1), Xi(c, x));
            return y.return(q);
          case 10:
            throw (
              (b(),
              ...
              si(u, c.name, '', null !== (g = c.options.version) && void 0 !== g ? g : -1))
            );
        }
      });
    }
  ...
  var Zi = new Wi('YtIdbMeta', {
    ia: { databases: { ya: 1 } },
    upgrade: function (a, b) {
      b(1) && Fi(a, 'databases', { keyPath: 'actualName' });
    }
  });
  function $i(a, b) {
    var c;
    return z(function (d) {
      if (1 == d.h) return w(d, Yi(Zi, b), 2);
      c = d.i;
      return d.return(
        W(c, ['databases'], { G: !0, mode: 'readwrite' }, function (e) {
          ...
          return f.get(a.actualName).then(function (g) {
            if (
              ...
              return U(f.h.put(a, void 0)).then(function () {});
          });
        })
      );
    });
  ...
  function aj(a, b) {
    var c;
    return z(function (d) {
      if (1 == d.h) return a ? w(d, Yi(Zi, b), 2) : d.return();
      c = d.i;
    ...
    return z(function (e) {
      return 1 == e.h
        ...
        ? ((d = e.i),
          w(
            e,
            W(d, ['databases'], { G: !0, mode: 'readonly' }, function (f) {
              c.length = 0;
              return Ni(f.objectStore('databases'), {}, function (g) {
                a(g.X()) && c.push(g.X());
                return g.continue();
              });
            }),
    ...
    return z(function (d) {
      switch (d.h) {
        case 1:
          ...
          var e;
          if ((e = Og)) (e = /WebKit\/([0-9]+)/.exec(Ab())), (e = !!(e && 600 <= parseInt(e[1], 10)));
          e && ((e = /WebKit\/([0-9]+)/.exec(Ab())), (e = !(e && 602 <= parseInt(e[1], 10))));
          if (e || Tb) return d.return(!1);
          try {
          ...
          return w(d, $i(c, ej), 4);
        case 4:
          return w(d, aj('yt-idb-test-do-not-use', ej), 5);
        case 5:
          return d.return(!0);
        case 2:
  ...
  function gj() {
    if (void 0 !== dj) return dj;
    bi = !0;
    return (dj = fj().then(function (a) {
      bi = !1;
      var b, c;
      null !== (b = Zh()) &&
        void 0 !== b &&
        ...
        null === (c = Zh()) || void 0 === c ? void 0 : c.set('LAST_RESULT_ENTRY_KEY', b, 2592e3, !0));
      return a;
    }));
  }
  function hj() {
  ...
  function ij() {
    ...
    return a
      ? Promise.resolve(a)
      : gj().then(function (b) {
          (b = b ? ej : void 0) && E('ytglobal.idbToken_', b);
          return b;
        });
  }
  new Be();
  function jj(a) {
    if (!fi()) throw ((a = new S('AUTH_INVALID', { dbName: a })), ci(a), a);
    var b = gi();
  ...
  function kj(a, b, c, d) {
    ...
    return z(function (n) {
      switch (n.h) {
        case 1:
          return (f = null !== (e = Error().stack) && void 0 !== e ? e : ''), w(n, ij(), 2);
        case 2:
          g = n.i;
          if (!g)
            throw (
              ((h = ti('openDbImpl', a, b)),
              Q('ytidb_async_stack_killswitch') || (h.stack = h.stack + '\n' + f.substring(f.indexOf('\n') + 1)),
              ci(h),
              h)
            );
          hi(a);
          k = c ? { actualName: a, publicName: a, userIdentifier: void 0 } : jj(a);
          ra(n, 3);
          return w(n, $i(k, g), 5);
        case 5:
          return w(n, Ti(k.actualName, b, d), 6);
        case 6:
          return n.return(n.i);
        case 3:
          return (l = ua(n)), ra(n, 7), w(n, aj(k.actualName, g), 9);
        case 9:
          sa(n, 8);
          break;
        case 7:
  ...
  function nj(a, b) {
    ...
    var c, d;
    return z(function (e) {
      if (1 == e.h) return w(e, ij(), 2);
      if (3 != e.h) {
        c = e.i;
        if (!c) return e.return();
        hi(a);
        d = jj(a);
        return w(e, Ui(d.actualName, b), 3);
      }
      return w(e, aj(d.actualName, c), 0);
    });
  }
  function oj(a, b, c) {
    a = a.map(function (d) {
      return z(function (e) {
        return 1 == e.h ? w(e, Ui(d.actualName, b), 2) : w(e, aj(d.actualName, c), 0);
      });
    });
  ...
  function rj(a) {
    ...
    this.now = Date.now;
    this.ea = !1;
    this.fb = null !== (b = a.fb) && void 0 !== b ? b : 100;
    this.cb = null !== (c = a.cb) && void 0 !== c ? c : 1;
    this.ab = null !== (d = a.ab) && void 0 !== d ? d : 2592e6;
    this.Za = null !== (e = a.Za) && void 0 !== e ? e : 12e4;
    this.bb = null !== (f = a.bb) && void 0 !== f ? f : 5e3;
    this.s = null !== (g = a.s) && void 0 !== g ? g : void 0;
    this.qa = !!a.qa;
    this.pa = null !== (h = a.pa) && void 0 !== h ? h : 0.1;
    ...
    this.Ha = a.Ha;
    this.Ga = a.Ga;
    this.s && (!this.v || this.v('networkless_logging')) && sj(this);
  }
  function sj(a) {
    return z(function (b) {
      if (1 == b.h) return !a.s || a.ea ? b.return() : a.qa && Math.random() <= a.pa ? w(b, a.C.mb(a.s), 2) : b.o(2);
      tj(a);
      a.F.D() && a.ka();
      a.F.Y(a.Ha, a.ka.bind(a));
      a.F.Y(a.Ga, a.La.bind(a));
      a.h = !0;
      b.h = 0;
    });
  }
  ...
  m.sendThenWrite = function (a, b, c) {
    ...
    if (this.s && this.h) {
      ...
      if (this.F.D() || (this.v && this.v('nwl_aggressive_send_then_write') && !e.skipRetry)) {
        if (!e.skipRetry) {
          ...
          b.onError = function (g, h) {
            return z(function (k) {
              if (1 == k.h)
                return w(
                  k,
                  d.C.set(e, d.s).catch(function (l) {
                    vj(d, l);
                  }),
                  2
                );
    ...
    } else this.R(a, b, this.v && this.v('nwl_skip_retry') && c);
  };
  m.sendAndWrite = function (a, b) {
    ...
    if (this.s && this.h) {
      ...
      d.options.onSuccess = function (g, h) {
        void 0 !== d.id ? c.C.aa(d.id, c.s) : (e = !0);
        c.F.V && c.v && c.v('vss_network_hint') && c.F.V(!0);
        f(g, h);
      };
  ...
  m.ka = function () {
    var a = this;
    if (!this.s) throw ti('throttleSend');
    this.i ||
      (this.i = this.K.L(function () {
        var b;
        return z(function (c) {
          if (1 == c.h) return w(c, a.C.Ra('NEW', a.s), 2);
          if (3 != c.h) return (b = c.i), b ? w(c, uj(a, b), 3) : (a.La(), c.return());
          a.i && ((a.i = 0), a.ka());
          c.h = 0;
        });
      }, this.fb));
  ...
  function uj(a, b) {
    ...
    return z(function (e) {
      switch (e.h) {
        case 1:
          if (!a.s) throw ((c = ti('immediateSend')), c);
          if (void 0 === b.id) {
            e.o(2);
            break;
          }
          return w(e, a.C.tb(b.id, a.s), 3);
        case 3:
        ...
        case 2:
          ...
          return w(e, a.C.aa(b.id, a.s), 5);
        case 5:
          return e.return();
        case 4:
          b.skipRetry || (b = xj(a, b));
          if (!b) {
            e.o(0);
            break;
          }
          ...
          return w(e, a.C.aa(b.id, a.s), 8);
        case 8:
          a.R(b.url, b.options, !!b.skipRetry), (e.h = 0);
      }
    });
  }
  function xj(a, b) {
    if (!a.s) throw ti('updateRequestHandlers');
      ...
      return z(function (h) {
        switch (h.h) {
          case 1:
            ...
            if (
              !(
                ...
                (a.v && !a.v('nwl_consider_error_code') && a.potentialEsfErrorCounter <= a.va)
              )
            ) {
              h.o(2);
              break;
          ...
          case 3:
            ...
            c(e, f);
            if (!a.v || !a.v('nwl_consider_error_code') || void 0 === (null === b || void 0 === b ? void 0 : b.id)) {
              h.o(6);
              break;
            }
            return w(h, a.C.Ia(b.id, a.s, !1), 6);
          case 6:
            return h.return();
          case 2:
            if (a.v && a.v('nwl_consider_error_code') && !g && a.potentialEsfErrorCounter > a.va) return h.return();
            a.potentialEsfErrorCounter++;
            if (void 0 === (null === b || void 0 === b ? void 0 : b.id)) {
              h.o(8);
              break;
            }
            return b.sendCount < a.cb ? w(h, a.C.Ia(b.id, a.s), 12) : w(h, a.C.aa(b.id, a.s), 8);
          case 12:
            a.K.L(function () {
              a.F.D() && a.ka();
            }, a.bb);
    ...
    b.options.onSuccess = function (e, f) {
      return z(function (g) {
        if (1 == g.h)
          return void 0 === (null === b || void 0 === b ? void 0 : b.id) ? g.o(2) : w(g, a.C.aa(b.id, a.s), 2);
        a.F.V && a.v && a.v('vss_network_hint') && a.F.V(!0);
        d(e, f);
        g.h = 0;
      });
    };
  ...
  function tj(a) {
    if (!a.s) throw ti('retryQueuedRequests');
    a.C.Ra('QUEUED', a.s).then(function (b) {
      b && !wj(a, b, a.Za)
        ? a.K.L(function () {
            return z(function (c) {
              if (1 == c.h) return void 0 === b.id ? c.o(2) : w(c, a.C.Ia(b.id, a.s), 2);
              tj(a);
              c.h = 0;
            });
          })
  ...
  function vj(a, b) {
    a.gb && !a.F.D() ? a.gb(b) : a.handleError(b);
  }
  function yj(a) {
    var b;
    return (a = null === (b = null === a || void 0 === a ? void 0 : a.error) || void 0 === b ? void 0 : b.code) &&
      400 <= a &&
      599 >= a
      ? !1
      : !0;
  }
  var zj = C('ytPubsub2Pubsub2Instance') || new L();
  L.prototype.subscribe = L.prototype.subscribe;
  L.prototype.unsubscribeByKey = L.prototype.la;
  L.prototype.publish = L.prototype.ca;
  L.prototype.clear = L.prototype.clear;
  E('ytPubsub2Pubsub2Instance', zj);
  ...
  Aj.prototype.j = function (a, b, c) {
    c = void 0 === c ? {} : c;
    return (this.options.Ja ? mj : lj)(a, b, Object.assign({}, c));
  };
  Aj.prototype.delete = function (a) {
    a = void 0 === a ? {} : a;
    return (this.options.Ja ? qj : nj)(this.name, a);
  };
  function Cj(a, b) {
    return Bj(a, b);
  }
  ...
  function Ej() {
    if (Dj) return Dj();
    var a = {};
    Dj = Cj('LogsDatabaseV2', {
      ia: ((a.LogsRequestsStore = { ya: 2 }), a),
      Ja: !1,
      upgrade: function (b, c, d) {
        c(2) && Fi(b, 'LogsRequestsStore', { keyPath: 'id', autoIncrement: !0 });
        c(3);
        c(5) &&
          ((d = d.objectStore('LogsRequestsStore')),
          d.h.indexNames.contains('newRequest') && d.h.deleteIndex('newRequest'),
          d.h.createIndex('newRequestV2', ['status', 'interface', 'timestamp'], { unique: !1 }));
  ...
  function Ij(a, b) {
    ...
    return z(function (l) {
      ...
      if (3 != l.h)
        return (
          (d = l.i),
          (e = O('INNERTUBE_CONTEXT_CLIENT_NAME', 0)),
          (f = [a, e, 0]),
          (g = [a, e, R()]),
          ...
          w(
            l,
            W(d, ['LogsRequestsStore'], { mode: 'readwrite', G: !0 }, function (n) {
              return Qi(
  ...
  function Jj(a, b) {
    var c;
    return z(function (d) {
      if (1 == d.h) return w(d, Fj(b), 2);
      c = d.i;
      return d.return(
        W(c, ['LogsRequestsStore'], { mode: 'readwrite', G: !0 }, function (e) {
          var f = e.objectStore('LogsRequestsStore');
          return f.get(a).then(function (g) {
            if (g)
              return (
                (g.status = 'QUEUED'),
                U(f.h.put(g, void 0)).then(function () {
                  return g;
                })
              );
          });
  ...
  function Kj(a, b, c) {
    ...
    var d;
    return z(function (e) {
      if (1 == e.h) return w(e, Fj(b), 2);
      d = e.i;
      return e.return(
        W(d, ['LogsRequestsStore'], { mode: 'readwrite', G: !0 }, function (f) {
          var g = f.objectStore('LogsRequestsStore');
          return g.get(a).then(function (h) {
            return h
              ? ((h.status = 'NEW'),
                c && (h.sendCount += 1),
                U(g.h.put(h, void 0)).then(function () {
                  return h;
                }))
              : T.resolve(void 0);
          });
  ...
  function Mj(a) {
    var b, c;
    return z(function (d) {
      if (1 == d.h) return w(d, Fj(a), 2);
      b = d.i;
      c = R() - 2592e6;
      return w(
        d,
        W(b, ['LogsRequestsStore'], { mode: 'readwrite', G: !0 }, function (e) {
          return Ni(e.objectStore('LogsRequestsStore'), {}, function (f) {
            if (f.X().timestamp <= c)
  ...
  var Oj = {},
    Qj = Cj('ServiceWorkerLogsDatabase', {
      ia: ((Oj.SWHealthLog = { ya: 1 }), Oj),
      Ja: !0,
      upgrade: function (a, b) {
        b(1) &&
          Fi(a, 'SWHealthLog', {
  ...
  function Sj(a) {
    var b, c;
    z(function (d) {
      if (1 == d.h) return w(d, Rj(a), 2);
      b = d.i;
      c = R() - 2592e6;
      return w(
        d,
        W(b, ['SWHealthLog'], { mode: 'readwrite', G: !0 }, function (e) {
          return Ni(e.objectStore('SWHealthLog'), {}, function (f) {
            if (f.X().timestamp <= c)
              return f.delete().then(function () {
                return f.continue();
              });
  ...
  var Uj;
  function Vj() {
    Uj || (Uj = new Th('yt.offline'));
    return Uj;
  }
  function Wj(a) {
    if (Q('offline_error_handling')) {
      var b = Vj().get('errors', !0) || {};
      b[a.message] = { name: a.name, stack: a.stack };
      a.level && (b[a.message].level = a.level);
      Vj().set('errors', b, 2592e3, !0);
    }
  }
  function Xj() {
    if (Q('offline_error_handling')) {
      var a = Vj().get('errors', !0);
      if (a) {
        for (var b in a)
          if (a[b]) {
            var c = new ei(b, 'sent via offline_errors');
            c.name = a[b].name;
            c.stack = a[b].stack;
            c.level = a[b].level;
            Qf(c);
          }
        Vj().set('errors', {}, 2592e3, !0);
      }
    }
  }
  var Yj = lg('network_polling_interval', 3e4);
  function X() {
    K.call(this);
    this.O = 0;
    this.ma = this.m = !1;
    this.j = this.Aa();
    Q('use_shared_nsm') ? (Nd.h || (Nd.h = new Nd(wg)), (this.i = Nd.h)) : (Zj(this), ak(this));
  }
  v(X, K);
  function bk() {
    if (!X.h) {
  ...
  m.D = function () {
    var a;
    return Q('use_shared_nsm') && this.i ? (null === (a = this.i) || void 0 === a ? void 0 : a.D()) : this.j;
  };
  m.V = function (a) {
    var b;
    Q('use_shared_nsm') && this.i
  ...
  m.ub = function (a) {
    !Q('use_shared_nsm') && ((this.m = !0), void 0 === a ? 0 : a) && (this.O || ck(this));
  };
  m.Aa = function () {
  ...
  m.Y = function (a, b) {
    return Q('use_shared_nsm') && this.i ? this.i.Y(a, b) : K.prototype.Y.call(this, a, b);
  };
  function ak(a) {
    window.addEventListener('online', function () {
      return z(function (b) {
        if (1 == b.h) return w(b, a.S(), 2);
        a.ma && Xj();
        b.h = 0;
      });
    });
  ...
  function ck(a) {
    a.O = rg(function () {
      return z(function (b) {
        if (1 == b.h) return a.j ? (a.Aa() || !a.m ? b.o(3) : w(b, a.S(), 3)) : w(b, a.S(), 3);
        ck(a);
        b.h = 0;
      });
    }, Yj);
  ...
  m.S = function (a) {
    var b = this;
    return Q('use_shared_nsm') && this.i
      ? Od(this.i, a)
      : this.u
      ? this.u
      : (this.u = new Promise(function (c) {
          var d, e, f;
          return z(function (g) {
            switch (g.h) {
              case 1:
              ...
              case 3:
                ...
                b.B && wg.W(b.B);
                f !== b.j &&
                  ((b.j = f), b.j && b.m ? Ld(b, 'ytnetworkstatus-online') : b.m && Ld(b, 'ytnetworkstatus-offline'));
                c(f);
                wa(g);
                break;
              case 2:
  ...
  X.prototype.sendNetworkCheckRequest = X.prototype.S;
  X.prototype.listen = X.prototype.Y;
  X.prototype.enableErrorFlushing = X.prototype.ob;
  X.prototype.getWindowStatus = X.prototype.Aa;
  X.prototype.monitorNetworkStatusChange = X.prototype.ub;
  ...
  function dk(a) {
    ...
    Q('use_shared_nsm') && ((this.m = 'networkstatus-offline'), (this.u = 'networkstatus-online'));
    this.i = bk();
    var c = C('yt.networkStatusManager.instance.monitorNetworkStatusChange').bind(this.i);
    c && c(a.Oa);
    a.sa && !Q('use_shared_nsm') && (c = C('yt.networkStatusManager.instance.enableErrorFlushing').bind(this.i)) && c();
    if ((c = C('yt.networkStatusManager.instance.listen').bind(this.i)))
      a.wa
        ? ((this.wa = a.wa),
          c(this.u, function () {
            ek(b, 'publicytnetworkstatus-online');
            Q('use_shared_nsm') && a.sa && Xj();
          }),
          c(this.m, function () {
            ek(b, 'publicytnetworkstatus-offline');
          }))
        : (c(this.u, function () {
            Ld(b, 'publicytnetworkstatus-online');
            Q('use_shared_nsm') && a.sa && Xj();
          }),
          c(this.m, function () {
            Ld(b, 'publicytnetworkstatus-offline');
          }));
  }
  v(dk, K);
  ...
  dk.prototype.S = function (a) {
    var b = this,
      c;
    return z(function (d) {
      return (c = C('yt.networkStatusManager.instance.sendNetworkCheckRequest').bind(b.i))
        ? d.return(c(a))
        : d.return(!0);
    });
  };
  ...
  function gk() {
    rj.call(this, {
      C: { mb: Mj, aa: Lj, Ra: Ij, tb: Jj, Ia: Kj, set: Gj },
      F: hk(),
      handleError: Qf,
      ba: Rf,
      R: ik,
      ...
      gb: Wj,
      K: vg(),
      Ha: 'publicytnetworkstatus-online',
      Ga: 'publicytnetworkstatus-offline',
      qa: !0,
      pa: 0.1,
      va: lg('potential_esf_error_limit', 10),
      v: Q,
      ea: !fi()
    });
    this.j = new Be();
    this.qa && Math.random() <= this.pa && this.s && Sj(this.s);
    Q('networkless_immediately_drop_sw_health_store') && jk(this);
    Q('networkless_immediately_drop_all_requests') && Nj();
    qj('LogsDatabaseV2');
  }
  v(gk, rj);
  function kk() {
    ...
    a ||
      ...
      Q('networkless_logging') &&
        ij().then(function (b) {
          return z(function (c) {
            if (1 == c.h) return (a.s = b), w(c, sj(a), 2);
            a.j.resolve();
            c.h = 0;
          });
        }));
  ...
  gk.prototype.writeThenSend = function (a, b) {
    b || (b = {});
    fi() || (this.h = !1);
    rj.prototype.writeThenSend.call(this, a, b);
  };
  gk.prototype.sendThenWrite = function (a, b, c) {
    b || (b = {});
    fi() || (this.h = !1);
    rj.prototype.sendThenWrite.call(this, a, b, c);
  };
  gk.prototype.sendAndWrite = function (a, b) {
    b || (b = {});
    fi() || (this.h = !1);
    rj.prototype.sendAndWrite.call(this, a, b);
  };
  function jk(a) {
    var b;
    z(function (c) {
      if (!a.s) throw ((b = ti('clearSWHealthLogsDb')), b);
      return c.return(
        Tj(a.s).catch(function (d) {
          a.handleError(d);
        })
      );
    });
  ...
  function ik(a, b, c) {
    var d;
    if (null === (d = b.postParams) || void 0 === d ? 0 : d.requestTimeMs) b.postParams.requestTimeMs = Math.round(R());
    c && 0 === Object.keys(b).length ? Sg(a) : Gg(a, b);
  }
  function hk() {
    fk || (fk = new dk({ sa: !0, Oa: !0 }));
    return fk;
  }
  var lk = 0,
    mk = 0,
    nk,
    ok = B.ytNetworklessLoggingInitializationOptions || {
      isNwlInitialized: !1,
      potentialEsfErrorCounter: mk
    };
  E('ytNetworklessLoggingInitializationOptions', ok);
  function pk(a, b) {
    function c(d) {
      var e = qk().D();
      if (!rk() || !d || (e && Q('vss_networkless_bypass_write'))) sk(a, b);
      else {
        var f = {
          url: a,
          options: b,
    ...
    function c(d) {
      if (rk() && d) {
        ...
        e.options.onSuccess = function (h, k) {
          void 0 !== e.id ? Lj(e.id, d) : (f = !0);
          Q('vss_network_hint') && qk().V(!0);
          g(h, k);
        };
        sk(e.url, e.options);
        Gj(e, d)
  ...
  function vk() {
    var a = hj();
    if (!a) throw ti('throttleSend');
    lk ||
      (lk = wg.L(function () {
        var b;
        return z(function (c) {
          if (1 == c.h) return w(c, Ij('NEW', a), 2);
          if (3 != c.h) return (b = c.i), b ? w(c, tk(b), 3) : (wg.W(lk), (lk = 0), c.return());
          lk && ((lk = 0), vk());
          c.h = 0;
        });
      }, 100));
  ...
  function tk(a) {
    ...
    return z(function (e) {
      switch (e.h) {
        case 1:
          b = hj();
          if (!b) throw ((c = ti('immediateSend')), c);
          if (void 0 === a.id) {
            e.o(2);
            break;
          }
          return w(e, Jj(a.id, b), 3);
        case 3:
        ...
        case 4:
          ...
          if (
            null ===
              (h =
                null === (g = null === f || void 0 === f ? void 0 : f.options) || void 0 === g
                  ? void 0
                  : g.postParams) || void 0 === h
              ? 0
              : h.requestTimeMs
          )
            f.options.postParams.requestTimeMs = Math.round(R());
          a = f;
          if (!a) {
            e.o(0);
            break;
          ...
          return w(e, Lj(a.id, b), 8);
        case 8:
          sk(a.url, a.options, !!a.skipRetry), (e.h = 0);
      }
    });
  }
  function wk(a) {
    var b = hj();
    if (!b) throw ti('updateRequestHandlers');
      ...
      return z(function (h) {
        switch (h.h) {
          case 1:
            ...
            if (
              !(
                (Q('nwl_consider_error_code') && g) ||
                (!Q('nwl_consider_error_code') && xk() <= lg('potential_esf_error_limit', 10))
              )
            ) {
              h.o(2);
              break;
          ...
          case 3:
            ...
            c(e, f);
            if (!Q('nwl_consider_error_code') || void 0 === (null === a || void 0 === a ? void 0 : a.id)) {
              h.o(5);
              break;
            }
            return w(h, Kj(a.id, b, !1), 5);
          case 5:
            return h.return();
          case 2:
            if (Q('nwl_consider_error_code') && !g && xk() > lg('potential_esf_error_limit', 10)) return h.return();
            C('ytNetworklessLoggingInitializationOptions') && ok.potentialEsfErrorCounter++;
            mk++;
            if (void 0 === (null === a || void 0 === a ? void 0 : a.id)) {
              h.o(7);
              break;
            }
            return 1 > a.sendCount ? w(h, Kj(a.id, b), 11) : w(h, Lj(a.id, b), 7);
          case 11:
            wg.L(function () {
              qk().D() && vk();
            }, 5e3);
    ...
    a.options.onSuccess = function (e, f) {
      return z(function (g) {
        if (1 == g.h) return void 0 === (null === a || void 0 === a ? void 0 : a.id) ? g.o(2) : w(g, Lj(a.id, b), 2);
        Q('vss_network_hint') && qk().V(!0);
        d(e, f);
        g.h = 0;
      });
  ...
  function qk() {
    if (Q('use_new_nwl')) return hk();
    nk || (nk = new dk({ sa: !0, Oa: !0 }));
    return nk;
  }
  function sk(a, b, c) {
    c && 0 === Object.keys(b).length ? Sg(a) : Gg(a, b);
  ...
  function rk() {
    return C('ytNetworklessLoggingInitializationOptions') ? ok.isNwlInitialized : !1;
  }
  function xk() {
    return C('ytNetworklessLoggingInitializationOptions') ? ok.potentialEsfErrorCounter : mk;
  }
  function yk(a) {
    var b = this;
    this.config_ = null;
    a ? (this.config_ = a) : Lh() && (this.config_ = th());
    rg(function () {
      Yh(b);
    }, 5e3);
  }
  yk.prototype.isReady = function () {
    !this.config_ && Lh() && (this.config_ = th());
    return !!this.config_;
  };
  function xh(a, b, c, d) {
    function e(x) {
      ...
      if (
        ...
        (x || Q('skip_ls_gel_retry') || 'application/json' !== g.headers['Content-Type'] || (y = Wh(b, c, l, k)), y)
      ) {
        var A = g.onSuccess,
          M = g.onFetchSuccess;
        g.onSuccess = function (N, P) {
          Xh(y);
          A(N, P);
        };
        c.onFetchSuccess = function (N, P) {
          Xh(y);
          M(N, P);
        };
      }
      try {
        x && d.retry && !d.Xa.bypassNetworkless
          ? ((g.method = 'POST'),
            d.Xa.writeThenSend
              ? Q('use_new_nwl')
                ? kk().writeThenSend(q, g)
                : pk(q, g)
              : Q('use_new_nwl')
              ? kk().sendAndWrite(q, g)
              : uk(q, g))
          : ((g.method = 'POST'), g.postParams || (g.postParams = {}), Gg(q, g));
      } catch (N) {
        if ('InvalidAccessError' == N.name)
          y && (Xh(y), (y = 0)), Rf(Error('An extension is blocking network request.'));
        else throw N;
      }
      y &&
        rg(function () {
    ...
    !O('VISITOR_DATA') &&
      'visitor_id' !== b &&
      0.01 > Math.random() &&
      Rf(new ei('Missing VISITOR_DATA when sending innertube request.', b, c, d));
    if (!a.isReady()) {
      var f = new ei('innertube xhrclient not ready', b, c, d);
      Qf(f);
      throw f;
    }
    var g = {
    ...
    var n = '/youtubei/' + a.config_.innertubeApiVersion + '/' + b,
      p = { alt: 'json' },
      u = a.config_.rb && f;
    Q('omit_innertube_api_key_for_bearer_auth_header') && (u = u && f.startsWith('Bearer'));
  ...
  function zk(a, b) {
    var c = void 0 === c ? {} : c;
    var d = yk;
    O('ytLoggingEventsDefaultDisabled', !1) && yk == yk && (d = null);
    a: {
      c = void 0 === c ? {} : c;
      if (Q('lr_drop_other_and_business_payloads')) {
        if (pg[a] || og[a]) break a;
      } else if (Q('lr_drop_other_payloads') && pg[a]) break a;
      var e = {},
      ...
      Q('log_sequence_info_on_gel_web') &&
        ...
        ((a = e.context),
        (b = c.eb),
        (Dh[b] = b in Dh ? Dh[b] + 1 : 0),
        (a.sequence = { index: Dh[b], groupKey: b }),
        c.Sb && delete Dh[c.eb]);
      (c.Yb ? ph : lh)({ endpoint: 'log_event', payload: e, da: c.da, za: c.za }, d);
    }
  }
  var Ak = [
    {
  ...
  function Fk() {
    if (!Ek) {
      ...
      a.U.length = 0;
      a.T.length = 0;
      Ck.U && a.U.push.apply(a.U, Ck.U);
      Ck.T && a.T.push.apply(a.T, Ck.T);
    }
    return Ek;
  }
  var Gk = new L();
  ...
  function Jk(a, b, c, d) {
    if (a)
      if (Array.isArray(a)) {
        var e = d;
        for (d = 0; d < a.length && !(a[d] && ((e += Kk(d, a[d], b, c)), 500 < e)); d++);
        d = e;
        ...
        for (e in a) {
          if (a[e]) {
            ...
            var h = c;
            g =
              'string' !== typeof f || ('clickTrackingParams' !== e && 'trackingParams' !== e)
                ? 0
                : (f = Hk(atob(f.replace(/-/g, '+').replace(/_/g, '/'))))
                ? Kk(e + '.ve', f, g, h)
                : 0;
            d += g;
            d += Kk(e, a[e], b, c);
  ...
  var Mk = new Set(),
    ...
    Pk = 0,
    Qk = [],
    Rk = ['PhantomJS', 'Googlebot', 'TO STOP THIS SECURITY SCAN go/scan'];
  var Sk = {};
  function Tk(a) {
    return (
      Sk[a] ||
      (Sk[a] = String(a).replace(/\-([a-z])/g, function (b, c) {
  ...
  var Uk = {},
    ...
    Wk = {};
  function Xk() {
    for (var a = t(Vk), b = a.next(); !b.done; b = a.next()) (b = b.value), b();
  }
  function Yk(a, b) {
    var c;
    'yt:' === a.tagName.toLowerCase().substr(0, 3)
      ? (c = a.getAttribute(b))
      : (c = a ? (a.dataset ? a.dataset[Tk(b)] : a.getAttribute('data-' + b)) : null);
    return c;
  }
  function Zk(a) {
    Te.ca.apply(Te, arguments);
  }
  function $k(a) {
    this.h = a || {};
      ...
      Zf(window, 'message', function (d) {
        a: {
          if (d.origin === Y(a, 'host')) {
            ...
            if ((d = bl[e.id])) (d.u = !0), d.u && (G(d.A, d.sendMessage, d), (d.A.length = 0)), d.Ka(e);
          }
          e = void 0;
        }
        return e;
  ...
  m.destroy = function () {
    this.h && this.h.id && (Uk[this.h.id] = null);
    (0, gd)(this.l);
    if (this.m) {
      var a = this.h,
        b = a.parentNode;
  ...
  function gl(a, b, c) {
    ...
    a.u ? a.sendMessage(b) : a.A.push(b);
  }
  function dl(a, b, c) {
    a.l.l || ((c = { target: a, data: c }), a.l.ca(b, c), Zk(a.B + '.' + b, c));
  }
  function hl(a, b) {
    ...
    window.location.href &&
      G(['debugjs', 'debugcss'], function (h) {
        var k = Nb(window.location.href, h);
        null !== k && (g[h] = k);
      });
    window.yt_embedsTokenValue &&
      ((g.embedsTokenValue = encodeURIComponent(window.yt_embedsTokenValue)), delete window.yt_embedsTokenValue);
    c.src = Y(a.i, 'host') + ('/embed/' + Y(a.i, 'videoId')) + '?' + Lb(g);
    return c;
  }
  m.Ya = function () {
    this.h && this.h.contentWindow ? this.sendMessage({ event: 'listening' }) : window.clearInterval(this.j);
  };
  function il(a) {
    al(a.i, a, a.id);
    a.j = ag(a.Ya.bind(a));
    Zf(a.h, 'load', function () {
  ...
  m.setup = function (a, b) {
    ...
    if ((a = 'string' === typeof a ? c.getElementById(a) : a))
      if (
        ...
        b.host || (b.host = c ? Ib(a.src) : 'https://www.youtube.com'),
        (this.i = new $k(b)),
        c || ((b = hl(this, a)), (this.m = a), (c = a.parentNode) && c.replaceChild(b, a), (a = b)),
        (this.h = a),
        ...
        for (var e in Wk) Wk.hasOwnProperty(e) && fl(this, e);
      }
  };
  function el(a, b) {
    a.I[b] || ((a.I[b] = !0), gl(a, 'addEventListener', [b]));
  }
  m.sendMessage = function (a) {
    a.id = this.id;
    a.channel = 'widget';
    a = Ae(a);
    var b = [Ib(this.h.src || '').replace('http:', 'https:')];
          ...
          if (A.name && 'SyntaxError' === A.name) {
            if (!(A.message && 0 < A.message.indexOf("target origin ''"))) {
              var d = void 0,
                e = A;
              d = void 0 === d ? {} : d;
              d.name = O('INNERTUBE_CONTEXT_CLIENT_NAME', 1);
              d.version = O('INNERTUBE_CONTEXT_CLIENT_VERSION', void 0);
              var f = d || {};
              d = 'WARNING';
              d = void 0 === d ? 'ERROR' : d;
              if (e) {
                ...
                if (!(5 <= Nk)) {
                  ...
                  if (e.hasOwnProperty('args') && e.args && e.args.length)
                    for (g = 0; g < e.args.length && !((u = Jk(e.args[g], 'params.' + g, k, u)), 500 <= u); g++);
                  ...
                  if (Qk.length)
                    for (g = 0; g < Qk.length && !((u = Jk(Qk[g], 'params.context.' + g, k, u)), 500 <= u); g++);
                  ...
                  if ('IGNORED' === e.level) e = 0;
                    ...
                    a: {
                      ...
                      for (h = f.next(); !h.done; h = f.next())
                        if (((h = h.value), g.message && g.message.match(h.Vb))) {
                          e = h.weight;
                          break a;
                        }
                      e = t(e.T);
                  ...
                  for (f = g.next(); !f.done; f = g.next())
                    if (((f = f.value), f.ta[e.name]))
                      for (p = t(f.ta[e.name]), h = p.next(); !h.done; h = p.next())
                        if (((l = h.value), (h = e.message.match(l.regexp)))) {
                          e.params['params.error.original'] = h[0];
                          p = l.groups;
                          l = {};
                          for (n = 0; n < p.length; n++)
                            (l[p[n]] = h[n + 1]), (e.params['params.error.' + p[n]] = h[n + 1]);
                          e.message = f.Fa(l);
                          break;
                        }
                  e.params || (e.params = {});
                  ...
                  kb('sample').constructor !== ib && (e.params['params.fconst'] = 'true');
                  window.yterr && 'function' === typeof window.yterr && window.yterr(e);
                  if (0 !== e.sampleWeight && !Mk.has(e.message)) {
                    'ERROR' === d
                      ? (Gk.ca('handleError', e),
                        Q('record_app_crashed_web') &&
                          ...
                          zk('appCrashed', g)),
                        Ok++)
                      : 'WARNING' === d && Gk.ca('handleWarning', e);
                    if (Q('kevlar_gel_error_routing')) {
                      ...
                      if (f) f = void 0;
                        ...
                        0 !== f.length &&
                          (1 !== f.length || isNaN(Number(f[0]))
                            ? 2 !== f.length ||
                              isNaN(Number(f[0])) ||
                              isNaN(Number(f[1])) ||
                              ((p.lineNumber = Number(f[0])), (p.columnNumber = Number(f[1])))
                            : (p.lineNumber = Number(f[0])));
                        f = {
                        ...
                        'ERROR' === g
                          ...
                          : 'WARNING' === g && (f.level = 'ERROR_LEVEL_WARNNING');
                        p = { isObfuscated: !0, browserStackInfo: p };
                        l = { pageUrl: window.location.href, kvPairs: [] };
                        O('FEXP_EXPERIMENTS') && (l.experimentIds = O('FEXP_EXPERIMENTS'));
                        n = Mf();
                        k = (k = If.EXPERIMENT_FLAGS) ? k.web_disable_gel_stp_ecatcher_killswitch : void 0;
                        if (!k && n)
                          for (u = t(Object.keys(n)), k = u.next(); !k.done; k = u.next())
                            (k = k.value), l.kvPairs.push({ key: k, value: String(n[k]) });
                        if ((h = h.params))
                          for (n = t(Object.keys(h)), k = n.next(); !k.done; k = n.next())
                            (k = k.value),
                              l.kvPairs.push({
                                key: 'client.' + k,
                                value: String(h[k])
                              });
                        h = O('SERVER_NAME', void 0);
                        n = O('SERVER_VERSION', void 0);
                        h &&
                          n &&
                          (l.kvPairs.push({ key: 'server.name', value: h }),
                          l.kvPairs.push({ key: 'server.version', value: n }));
                        f = { errorMetadata: l, stackTrace: p, logMessage: f };
                      }
                      f && (zk('clientError', f), ('ERROR' === g || Q('errors_flush_gel_always_killswitch')) && nh());
                    }
  ...
  function ll(a, b) {
    cl.call(this, a, Object.assign({ title: 'video player', videoId: '', width: 640, height: 360 }, b || {}), 'player');
    this.M = {};
    this.playerInfo = {};
  }
  v(ll, cl);
  ...
  m.Ka = function (a) {
    ...
    switch (b) {
      case 'apiInfoDelivery':
        if (D(a)) for (var c in a) a.hasOwnProperty(c) && (this.M[c] = a[c]);
        break;
      case 'infoDelivery':
        ml(this, a);
        break;
      case 'initialDelivery':
        D(a) &&
          (window.clearInterval(this.j), (this.playerInfo = {}), (this.M = {}), nl(this, a.apiInterface), ml(this, a));
        break;
      default:
        dl(this, b, a);
    }
  ...
  function ol(a) {
    if ('iframe' !== a.tagName.toLowerCase()) {
      var b = Yk(a, 'videoid');
      b && ((b = { videoId: b, width: Yk(a, 'width'), height: Yk(a, 'height') }), new ll(a, b));
    }
  }
  ...
  E('YT.subscribe', function (a, b, c) {
    Te.subscribe(a, b, c);
    Wk[a] = !0;
    for (var d in Uk) Uk.hasOwnProperty(d) && fl(Uk[d], a);
  });
  ...
  cl.prototype.setSize = cl.prototype.setSize;
  cl.prototype.getIframe = cl.prototype.getIframe;
  cl.prototype.addEventListener = cl.prototype.addEventListener;
  ll.prototype.getVideoEmbedCode = ll.prototype.getVideoEmbedCode;
  ll.prototype.getOptions = ll.prototype.getOptions;
  ll.prototype.getOption = ll.prototype.getOption;
  Vk.push(function (a) {
    var b = a;
    b || (b = document);
    ...
    if (c.querySelectorAll && c.querySelector) b = c.querySelectorAll('.yt-player');
      ...
      if (b.querySelectorAll && b.querySelector) b = b.querySelectorAll('.yt-player');
        ...
        for (c = d = 0; (b = e[c]); c++) {
          var g = b.className,
            h;
          if ((h = 'function' == typeof g.split)) h = 0 <= Va(g.split(/\s+/), 'yt-player');
          h && (f[d++] = b);
        }
        f.length = d;
        b = f;
  ...
  ('undefined' != typeof YTConfig && YTConfig.parsetags && 'onload' != YTConfig.parsetags) || Xk();
  var pl = B.onYTReady;
  pl && pl();
  var ql = B.onYouTubeIframeAPIReady;
  ql && ql();
  var rl = B.onYouTubePlayerAPIReady;
  rl && rl();
}).call(this);
